package crave.com.android.views;
...
import crave.com.android.adapter.NiceSpinnerAdapter;
import crave.com.android.adapter.NiceSpinnerAdapterWrapper;
import crave.com.android.adapter.NiceSpinnerBaseAdapter;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            mPopup.setBackgroundDrawable(ContextCompat.getDrawable(context, R.mipmap.drop_down_shadow));
        }
